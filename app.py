...
st.markdown("<h1>🎓Smart Career- Asistentul tău pentru un job de vis</h1>", unsafe_allow_html=True)
st.markdown("<p class='subtitle'>Aici te descoperi. De aici începe startul căutării! Pe platforma Smart Career îți poți introduce rapid domeniul de specializare, pasiunile și hobby-urile tale, iar modelul nostru îți va prezenta, în timp real, opțiunile cele mai potrivite pentru tine! /p>" , unsafe_allow_html=True)
st.write("---")
